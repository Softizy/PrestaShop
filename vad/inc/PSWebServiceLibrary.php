...
class PrestaShopWebservice
{
    ...
    static public function getWebservice()
    {
        define('PS_SHOP_PATH', _PS_BASE_URL_);
        $psWsAuthKey = Tools::getValue('ws_key');
        $debug = false;

        $webService = new PrestaShopWebservice(PS_SHOP_PATH, $psWsAuthKey, $debug);
